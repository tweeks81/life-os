...
import { RawCalendarEvent } from '@/lib/calendar'
import { EVENT_TYPE_LABELS, EVENT_TYPE_COLOURS } from '@/lib/calendar'
        ...
        <div className="modal-body">
          ...
          <div className="field-group">
            ...
            <p className="field-hint">
              {recurs
                ? 'The year is used to calculate how many years ago this was.'
                : 'This is a one-time event on this specific date.'}
            </p>
          </div>
