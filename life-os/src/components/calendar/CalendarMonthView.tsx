  ...
  return (
    <div className="month-view">
              ...
              return (
                ...
                >
                  ...
                  <div className="cell-events">
                    ...
                    {overflow > 0 && (
                      <span className="overflow-pill">+{overflow} more</span>
                    )}
                  </div>
                </div>
              )
      ...
      <style>{`
        ...
        .month-cell.other-month { background: var(--cream); opacity: 0.7; }
        .cell-date {
          display: flex;
...
function EventPill({
  ...
  const isDeletable = event.sourceId && !event.id.startsWith('holiday-') && !event.id.startsWith('contact-bday-') && !event.id.startsWith('my-birthday-')
