...
export default function SharePanel({
  ...
  const table = entityType === 'task' ? 'task_shares' : entityType === 'project' ? 'project_shares' : entityType === 'contact' ? 'contact_shares' : 'calendar_event_shares'
  const idField = entityType === 'task' ? 'task_id' : entityType === 'project' ? 'project_id' : entityType === 'contact' ? 'contact_id' : 'event_id'
